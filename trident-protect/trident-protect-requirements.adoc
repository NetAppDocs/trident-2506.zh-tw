...
summary: 首先，請驗證您的運行環境、應用程式叢集、應用程式和授權是否已準備就緒。請確保您的環境符合部署和執行Trident Protect 的這些要求。 
---
= Trident保護要求
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
首先，請驗證您的運行環境、應用程式叢集、應用程式和授權是否已準備就緒。請確保您的環境符合部署和執行Trident Protect 的這些要求。



== Trident保護 Kubernetes 叢集相容性
