...
summary: 在部署Trident之前，您必須在主機上安裝和設定必要的協定先決條件。 
---
= 部署先決條件
:hardbreaks:
:allow-uri-read: 
...
* 確認您的部署滿足所有要求link:../trident-get-started/requirements.html["要求"]。
* 請確認您已安裝受支援的 Docker 版本。如果您的 Docker 版本已過時， https://docs.docker.com/engine/install/["安裝或更新它"^] 。
+
[source, console]
----
docker --version
